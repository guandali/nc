...
int main(int argc, char **argv) {
    ...
    if(lflag){
        // if lfag nc behaves like a server
...
// build a server based on port, hostname
...
// read_write used to threads to be able write and read same
// time, in new implementation, I used poll to monitor POLLIN and
// and POLLOUT
void* read_write(int new_fd){
//    
//    pthread_t t1, t2;
...
// This version of readWrite uses poll
// pfd[0] for socket
// pfd[1] for user input
void* readWrite(int new_fd) {
    //////////////////////////////////////////////////
